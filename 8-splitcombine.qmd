...
are provided as metadata (e.g., 4x4x4):
...
There are two geological units in this deposit, represented as `GeoTableView`. We
...
box centered at the point with corners that are 2x2x2 units away in both directions:
