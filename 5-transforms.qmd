...
The `Identity` transform can be used to forward the geotable without modifications.
It will be useful in future chapters after we introduce transform pipelines:
...
that are not very clear due to file format limitations. To illustrate this transform,
let's create a geotable with unreadable variable names:
