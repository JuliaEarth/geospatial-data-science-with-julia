...
Always remind yourself that geoscience is **not** simple,
is **not** 2D, and is **not** software engineering. There are greater
challenges to address in the world with geospatial data science besides
computational performance and software specifications.
