...
**universal representation** for such data which is ideal for geostatistical
...
```{julia}
georef((R=rand(1000000), G=rand(1000000), B=rand(1000000)), CartesianGrid(1000, 1000))
```
...
- Geospatial data can be efficiently represented as a `GeoTable`.
  This representation is universal - it combines the
