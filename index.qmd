...
- [Citing](CITATION.bib) the project in publications

- Reviewing the text for mispellings

- [Asking questions](https://github.com/juliohm/geospatial-data-science-with-julia) and making suggestions

Another great way to get involved is by suggesting entirely
new code examples from geoscientific domains not covered in
