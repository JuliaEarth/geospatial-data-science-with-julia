...
people = georef(table, (:LONGITUDE, :LATITUDE)) |> Proj(Robinson)
```
...
countries = GeoIO.load("data/countries.geojson", numbertype = Float64) |> Proj(Robinson)
```
...
project to a `Robinson` CRS as discussed in the chapter
