...
and produces a connectivity object. The geometry type can be ommitted,
in which case it is assumed to be a `Ngon`:
...
Throughout the book, we will have the chance to explore these concepts
in more detail.
