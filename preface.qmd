...
some flexibility on how to read the parts. Although you could read **Parts II-IV** in any
...
# install framework
pkg"add GeoStats@0.46.0"

# install IO module
pkg"add GeoIO@1.2.0"

# install artifacts
pkg"add GeoArtifacts@0.1.0"

# install viz modules
pkg"add CairoMakie@0.10.10"
pkg"add PairPlots@1.1.2"
...
Some examples require data files that are stored on GitHub at
