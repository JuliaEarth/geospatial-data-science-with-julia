...
flowchart LR
  ...
  subgraph partIV["Part IV: Applications"]
    chapter10["10. Agricultural fields"]
    chapter11["11. Mine deposits"]
    chapter12["12. Oil reservrois"]
    chapter10 --> chapter11
    chapter11 --> chapter12
  end
  partI --> partII
...
examples in **Part II** and **Part III**. Finally, you can explore
the applications in **Part IV** to solidify the concepts.
