...
# install framework
pkg"add GeoStats@0.85.4"

# install IO module
pkg"add GeoIO@1.22.6"

# install viz modules
pkg"add CairoMakie@0.15.11"
pkg"add PairPlots@3.0.3"

# install other modules
pkg"add DataFrames@1.8.2"
```
...
[[![](images/juliahearts.gif){fig-alt="JuliaHearts" width=30px}](https://julialang.org)]{.content-visible when-format="html"}
