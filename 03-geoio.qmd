...
Several hard decisions lied in the path of disrupting existing practices and
developing something groundbreaking in Julia. One of these decisions relates to
how we are willing to interface our framework with existing GIS standards and workflows.
...
JuliaGeo organization has been doing over the years which
encourages people from other languages who are used to 
the [OGC](https://www.ogc.org/standards) standards - an important endeavor.
