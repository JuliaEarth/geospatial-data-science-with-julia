...
The larger the is exponent, the more abrupt is the transition of values
between the locations. The IDW solution will approximate the nearest
neighbor solution as $\beta \to \infty$:
