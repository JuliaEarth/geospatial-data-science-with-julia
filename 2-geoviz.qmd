...
In this book, we use **CairoMakie.jl** due to the large number of figures produced in code examples:
...
or numbers (automatically converted to colors):
...
work with geospatial transforms in [Part II](4-feattrans.qmd) of the book.
The pipe operator (`|>`) in Julia will be preferred for reasons that will
